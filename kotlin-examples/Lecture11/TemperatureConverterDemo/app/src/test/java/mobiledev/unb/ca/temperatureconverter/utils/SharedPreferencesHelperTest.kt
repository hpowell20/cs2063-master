...
class SharedPreferencesHelperTest {
    ...
    private var mockBrokenSharedPreferencesHelper: SharedPreferencesHelper? = null
    ...
    fun sharedPreferencesHelper_WhenSaveLastConversionSuccessful() {
        ...
        MatcherAssert.assertThat("SharedPreferenceEntry.save returns true", success, CoreMatchers.`is`(true))
    ...
    fun sharedPreferencesHelper_WhenSaveLastConversionFails() {
        ...
        MatcherAssert.assertThat("Should return false upon writing", success, CoreMatchers.`is`(false))
    }
