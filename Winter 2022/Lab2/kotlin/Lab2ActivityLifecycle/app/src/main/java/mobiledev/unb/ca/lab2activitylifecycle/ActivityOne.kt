...
import mobiledev.unb.ca.lab2activitylifecycle.ActivityOne
import mobiledev.unb.ca.lab2activitylifecycle.R
...
class ActivityOne : AppCompatActivity() {
    ...
    private val onStartCount = 0
    private val onResumeCount = 0
    private val onRestartCount = 0
    private var activityTwoButton: Button? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityTwoButton.setOnClickListener(View.OnClickListener {
            // HINT for 3:
