...
public class SharedPreferencesHelperTest {
    ...
    public void sharedPreferencesHelper_WhenSaveLastConversionSuccessful() {
        // Setup the SUT
        SharedPreferencesHelper mockSharedPreferencesHelper = createMockSharedPreference();
    ...
    public void sharedPreferencesHelper_WhenSaveLastConversionFails() {
        // Setup the SUT
        SharedPreferencesHelper mockBrokenSharedPreferencesHelper = createBrokenMockSharedPreference();
