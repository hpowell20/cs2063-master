...
public class MainActivity extends AppCompatActivity {
    ...
    public void playSound(View v) {
        int viewId = v.getId();
        if (viewId == R.id.button_sound1) {
            soundPool.autoPause(); // Pause all other sounds
            soundPool.play(sound1, 1, 1, 0, 0, 1);
        } else if (viewId == R.id.button_sound2) {
            soundPool.play(sound2, 1, 1, 0, 0, 1);
        } else if (viewId == R.id.button_sound3) {
            soundPool.play(sound3, 1, 1, 0, 0, 1);
        } else if (viewId == R.id.button_sound4) {
            soundPool.play(sound4, 1, 1, 0, 0, 1);
        } else if (viewId == R.id.button_sound5) {
