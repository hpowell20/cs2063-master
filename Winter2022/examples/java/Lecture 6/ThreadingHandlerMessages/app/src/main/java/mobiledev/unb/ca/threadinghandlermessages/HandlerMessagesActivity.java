...
public class HandlerMessagesActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null != savedInstanceState) {
            progressBar.setVisibility(savedInstanceState.getInt(PROGRESS_BAR_VISIBLE_KEY));
            progressBar.setProgress(savedInstanceState.getInt(PROGRESS_BAR_PROGRESS_KEY));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(PROGRESS_BAR_VISIBLE_KEY, progressBar.getVisibility());
        outState.putInt(PROGRESS_BAR_PROGRESS_KEY, progressBar.getProgress());
