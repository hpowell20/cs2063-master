...
public class ActivityOne extends Activity {
    ...
    private Button package mobiledev.unb.ca.lab2activitylifecycle;
...
import android.widget.TextView;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            activityTwoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mobiledev.unb.ca.lab2activitylifecycle.ActivityOne.this, ActivityTwo.class);
    ...
    //  declared as instances of the object type, much like when
    //  declaring an int, double, or String. All rules of Java continue to apply.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // HINT for 4:
        // This is how Android View layout resource references are obtained
        activityTwoButton = (Button) findViewById(R.id.btnLaunchActivityTwo);
        activityTwoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // HINT for 3:
        ...
        // TODO 4
        //  Use the above Button resource reference example to capture TextView
        //  references for onCreateText, onStartText, onResumeText, and onRestartText
    ...
    public void updateCountsDisplay() {
        ...
        // HINT:
        //  Follow the provided example where YourOnCreatetextVariableName
        //  refers to any of the TextViews defined in TODO 2.
        YourOnCreateTextVariableName.setText("onCreate() calls: " + onCreateCount);
    }
